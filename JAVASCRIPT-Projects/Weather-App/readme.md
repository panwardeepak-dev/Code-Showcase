...
1. Clone the repository:  
   ```bash
   git clone [https://github.com/panwardeepak-dev/Code-Showcase.git](https://github.com/panwardeepak-dev/Code-Showcase/blob/main/JAVASCRIPT-Projects/Weather-App/readme.md).git
